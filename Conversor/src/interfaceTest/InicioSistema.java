...
public class InicioSistema {
	...
	public static void main(String[] args) {
		...
		int opcionRepetir = 1;
		JOptionPane.showMessageDialog(null, "Bienvenido usted inicio conversor");
		//String cantidadS="";
		//double cantidad;
		...
		do {
			...
			if (opcionTipo == 0) {
				...
				while (i == 0) {
					if (opcion == opcion2) {
						JOptionPane.showMessageDialog(null, "No puede elegir la misma moneda", "alert", JOptionPane.ERROR_MESSAGE);
